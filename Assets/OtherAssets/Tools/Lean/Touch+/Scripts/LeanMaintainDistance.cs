	...
	public class LeanMaintainDistance : MonoBehaviour
	{
		...
		protected virtual void LateUpdate()
		{
			...
			if (CollisionLayers != 0)
			{
				...
				if (Physics.SphereCast(pointA, CollisionRadius, worldDirection, out rcHit, Vector3.Distance(pointA, pointB), CollisionLayers) == true)
				{
					var newDistance = rcHit.distance + ClampMin;
