...
namespace StylizedWater
{
    ...
    public class StylizedWaterURPEditor : Editor
    {
        ...
        private string shaderName = "Stylized Water/Stylized Water URP";
        ...
        #region Foam Shadows
        SerializedProperty enableFoamShadows, foamShadowStrength, foamShadowDepth, intersectionFoamShadowProjection, surfaceFoamShadowProjection;
        #endregion
        ...
        #region Sections
        SerializedProperty surfaceFoamExpanded, intersectionEffectsExpanded, causticsExpanded, foamShadowsExpanded, planarReflectionsExpanded;
        #endregion
        ...
        void DrawSections()
        {
            ...
            EditorGUILayout.Space();
            EditorGUILayout.LabelField("   " + stylizedWater.material.name + " - Stylized Water URP");
            EditorGUILayout.Space();
            ...
            // Func<bool> truef = new Func<bool>(() => true);
            // pos => OnContextClick(pos, "surface-foam")
