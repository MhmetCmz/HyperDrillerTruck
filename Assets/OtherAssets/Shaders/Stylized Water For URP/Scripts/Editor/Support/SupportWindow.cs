                ...
                if (listRequest.Status == StatusCode.Success)
                {
                    foreach (var package in listRequest.Result)
                    {
                        if (package.name == "com.unity.render-pipelines.universal")
                        {
                            ...
                            if (version.StartsWith("7.1.2") || version.StartsWith("7.1.3") || version.StartsWith("7.1.4") ||
                                version.StartsWith("7.1.5") || version.StartsWith("7.1.6") || version.StartsWith("7.1.7") || version.StartsWith("7.1.8") ||
                                version.StartsWith("7.2") || version.StartsWith("7.3") || version.StartsWith("7.4") ||
